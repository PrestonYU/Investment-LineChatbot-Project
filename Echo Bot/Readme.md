...
我們可以 Open App 或輸入我們的 Heroku App 網址應該可以看到畫面：
...
$ heroku ps:scale clock=0 -a {heroku app 名稱}
總結
以上介紹了雲端伺服器（Cloud Server）概要以及如何使用 git 和 heroku 將我們的 LINE 聊天機器人部屬到 Heroku 雲端伺服器上。現在同學們就可以試試看設計自己的聊天機器人放到雲端伺服器上了！
